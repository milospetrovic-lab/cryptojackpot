...
export function BannerCard() {
  ...
  return (
    <section className="relative mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14">
      <div
        ref={ref}
        // Mobile: content-sized card, no aspect-ratio, no forced min-height.
        // Desktop: 16/9 cinema card with the banner image behind the copy.
        className="relative overflow-hidden rounded-3xl border border-jp-gold-deep/30 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.9)] md:aspect-[16/9] md:min-h-[340px]"
      >
        ...
        {/* Layer 3 — copy */}
        <div className="relative z-10 flex min-w-0 flex-col justify-center px-4 py-7 md:h-full md:px-14 md:py-10">
          ...
          <div className="mt-6 flex flex-col items-stretch gap-2 sm:flex-row sm:flex-wrap sm:items-start sm:gap-3 md:mt-7">
            <Link
              href="/games"
              className="inline-flex min-w-0 items-center justify-center rounded-full bg-gradient-to-b from-jp-gold-pale via-jp-gold to-jp-gold-deep px-4 py-3 text-[11px] font-bold uppercase tracking-[0.2em] text-jp-obsidian shadow-gold-glow sm:px-7 sm:tracking-[0.24em]"
            >
              Enter the Vault
            </Link>
            <Link
              href="/promotions"
              className="inline-flex min-w-0 items-center justify-center rounded-full border border-jp-gold-deep/50 bg-black/40 px-4 py-3 text-[11px] font-bold uppercase tracking-[0.2em] text-jp-gold backdrop-blur hover:bg-black/60 sm:px-7 sm:tracking-[0.24em]"
            >
              This Week's Drops
            </Link>
          </div>
